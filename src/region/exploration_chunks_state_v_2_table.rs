...
impl ExplorationChunksStateV2TableAccess for super::RemoteTables {
    fn exploration_chunks_state_v_2(&self) -> ExplorationChunksStateV2TableHandle<'_> {
        ExplorationChunksStateV2TableHandle {
            imp: self.imp.get_table::<ExplorationChunksStateV2>("exploration_chunks_state_v2"),
...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        __sdk::InternalError::failed_parse(
            "TableUpdate<ExplorationChunksStateV2>",
            "TableUpdate",
        ).with_cause(e).into()
    })
}
        ...
        pub trait exploration_chunks_state_v_2QueryTableAccess {
            ...
            fn exploration_chunks_state_v_2(&self) -> __sdk::__query_builder::Table<ExplorationChunksStateV2>;
        }
