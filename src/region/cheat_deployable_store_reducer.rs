...
pub trait cheat_deployable_store {
    ...
    /// /// Use [`cheat_deployable_store:cheat_deployable_store_then`] to run a callback after the reducer completes.
    fn cheat_deployable_store(&self, deployable_entity_id: u64,
) -> __sdk::Result<()> {
        self.cheat_deployable_store_then(deployable_entity_id,  |_, _| {})
    }
    ...
    fn cheat_deployable_store_then(
        &self,
...
impl cheat_deployable_store for super::RemoteReducers {
    fn cheat_deployable_store_then(
        ...
        self.imp.invoke_reducer_with_callback(CheatDeployableStoreArgs { deployable_entity_id,  }, callback)
    }
}
