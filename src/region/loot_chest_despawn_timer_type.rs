...
impl __sdk::__query_builder::HasCols for LootChestDespawnTimer {
    ...
    fn cols(table_name: &'static str) -> Self::Cols {
        LootChestDespawnTimerCols {
            ...
            loot_chest_entity_id: __sdk::__query_builder::Col::new(table_name, "loot_chest_entity_id"),
...
impl __sdk::__query_builder::CanBeLookupTable for LootChestDespawnTimer {}
