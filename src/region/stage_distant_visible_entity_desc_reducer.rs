...
pub trait stage_distant_visible_entity_desc {
    ...
    /// /// Use [`stage_distant_visible_entity_desc:stage_distant_visible_entity_desc_then`] to run a callback after the reducer completes.
    fn stage_distant_visible_entity_desc(&self, records: Vec::<DistantVisibleEntityDesc>,
) -> __sdk::Result<()> {
        self.stage_distant_visible_entity_desc_then(records,  |_, _| {})
    }
    ...
    fn stage_distant_visible_entity_desc_then(
        &self,
...
impl stage_distant_visible_entity_desc for super::RemoteReducers {
    fn stage_distant_visible_entity_desc_then(
        ...
        self.imp.invoke_reducer_with_callback(StageDistantVisibleEntityDescArgs { records,  }, callback)
    }
}
