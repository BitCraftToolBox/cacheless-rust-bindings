...
pub trait cheat_quest_advance_to_handin {
    ...
    fn cheat_quest_advance_to_handin(&self, player_entity_id: u64,
quest_desc_id: i32,
) -> __sdk::Result<()> {
...
quest_desc_id: i32,
        ...
        self.imp.invoke_reducer_with_callback(CheatQuestAdvanceToHandinArgs { player_entity_id, quest_desc_id,  }, callback)
    }
}
