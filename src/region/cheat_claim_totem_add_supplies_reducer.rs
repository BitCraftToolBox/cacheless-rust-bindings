...
pub trait cheat_claim_totem_add_supplies {
    ...
    fn cheat_claim_totem_add_supplies(&self, claim_entity_id: u64,
amount: f32,
) -> __sdk::Result<()> {
...
amount: f32,
        ...
        self.imp.invoke_reducer_with_callback(CheatClaimTotemAddSuppliesArgs { claim_entity_id, amount,  }, callback)
    }
}
