...
impl __sdk::__query_builder::HasCols for ClimbRequirementDesc {
    ...
    fn cols(table_name: &'static str) -> Self::Cols {
        ClimbRequirementDescCols {
            ...
            min_climb_proficiency: __sdk::__query_builder::Col::new(table_name, "min_climb_proficiency"),
...
impl __sdk::__query_builder::CanBeLookupTable for ClimbRequirementDesc {}
