...
pub trait import_trade_order_state {
    ...
    /// /// Use [`import_trade_order_state:import_trade_order_state_then`] to run a callback after the reducer completes.
    fn import_trade_order_state(&self, records: Vec::<TradeOrderState>,
) -> __sdk::Result<()> {
        self.import_trade_order_state_then(records,  |_, _| {})
    }
    ...
    fn import_trade_order_state_then(
        &self,
...
impl import_trade_order_state for super::RemoteReducers {
    fn import_trade_order_state_then(
        ...
        self.imp.invoke_reducer_with_callback(ImportTradeOrderStateArgs { records,  }, callback)
    }
}
