...
pub trait pillar_shaping_place_pillar_start {
    ...
    fn pillar_shaping_place_pillar_start(&self, request: PlayerPillarShapingPlaceRequest,
) -> __sdk::Result<()> {
...
impl pillar_shaping_place_pillar_start for super::RemoteReducers {
    fn pillar_shaping_place_pillar_start_then(
        ...
        self.imp.invoke_reducer_with_callback(PillarShapingPlacePillarStartArgs { request,  }, callback)
    }
}
