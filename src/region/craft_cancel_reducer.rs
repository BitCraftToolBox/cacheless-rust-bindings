...
#[sats(crate = __lib)]
pub(super) struct CraftCancelArgs {
    pub request: PlayerCraftCancelRequest,
}

impl From<CraftCancelArgs> for super::Reducer {
...
impl craft_cancel for super::RemoteReducers {
    fn craft_cancel_then(
        ...
        self.imp.invoke_reducer_with_callback(CraftCancelArgs { request,  }, callback)
    }
}
