...
pub trait log_claim_member_leaderboard {
    ...
    /// /// Use [`log_claim_member_leaderboard:log_claim_member_leaderboard_then`] to run a callback after the reducer completes.
    fn log_claim_member_leaderboard(&self, ) -> __sdk::Result<()> {
        self.log_claim_member_leaderboard_then( |_, _| {})
    }
    ...
    fn log_claim_member_leaderboard_then(
        &self,
...
impl log_claim_member_leaderboard for super::RemoteReducers {
    fn log_claim_member_leaderboard_then(
        ...
        self.imp.invoke_reducer_with_callback(LogClaimMemberLeaderboardArgs {  }, callback)
    }
}
