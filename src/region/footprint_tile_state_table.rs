...
impl FootprintTileStateTableAccess for super::RemoteTables {
    fn footprint_tile_state(&self) -> FootprintTileStateTableHandle<'_> {
        FootprintTileStateTableHandle {
            imp: self.imp.get_table::<FootprintTileState>("footprint_tile_state"),
...
impl<'ctx> __sdk::TableLike for FootprintTileStateTableHandle<'ctx> {
    ...
    fn iter(&self) -> impl Iterator<Item = FootprintTileState> + '_ { self.imp.iter() }
}
...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        __sdk::InternalError::failed_parse(
            "TableUpdate<FootprintTileState>",
            "TableUpdate",
        ).with_cause(e).into()
    })
}
