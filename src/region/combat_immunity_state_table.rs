...
use super::combat_immunity_state_type::CombatImmunityState;

/// Table handle for the table `combat_immunity_state`.
///
/// Obtain a handle from the [`CombatImmunityStateTableAccess::combat_immunity_state`] method on [`super::RemoteTables`],
/// like `ctx.db.combat_immunity_state()`.
///
/// Users are encouraged not to explicitly reference this type,
/// but to directly chain method calls,
/// like `ctx.db.combat_immunity_state().on_insert(...)`.
pub struct CombatImmunityStateTableHandle<'ctx> {
    imp: __sdk::TableHandle<CombatImmunityState>,
...
pub trait CombatImmunityStateTableAccess {
    #[allow(non_snake_case)]
    /// Obtain a [`CombatImmunityStateTableHandle`], which mediates access to the table `combat_immunity_state`.
    fn combat_immunity_state(&self) -> CombatImmunityStateTableHandle<'_>;
}

impl CombatImmunityStateTableAccess for super::RemoteTables {
    fn combat_immunity_state(&self) -> CombatImmunityStateTableHandle<'_> {
        CombatImmunityStateTableHandle {
            imp: self.imp.get_table::<CombatImmunityState>("combat_immunity_state"),
...
impl<'ctx> __sdk::WithUpdate for CombatImmunityStateTableHandle<'ctx> {
    ...
    fn remove_on_update(&self, callback: CombatImmunityStateUpdateCallbackId) {
        ...
        /// via the [`CombatImmunityStateEntityIdUnique::find`] method.
        ///
        /// Users are encouraged not to explicitly reference this type,
        /// but to directly chain method calls,
        /// like `ctx.db.combat_immunity_state().entity_id().find(...)`.
        pub struct CombatImmunityStateEntityIdUnique<'ctx> {
            imp: __sdk::UniqueConstraintHandle<CombatImmunityState, u64>,
            phantom: std::marker::PhantomData<&'ctx super::RemoteTables>,
        }

        impl<'ctx> CombatImmunityStateTableHandle<'ctx> {
            /// Get a handle on the `entity_id` unique index on the table `combat_immunity_state`.
            pub fn entity_id(&self) -> CombatImmunityStateEntityIdUnique<'ctx> {
                CombatImmunityStateEntityIdUnique {
        ...
        impl<'ctx> CombatImmunityStateEntityIdUnique<'ctx> {
...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        __sdk::InternalError::failed_parse(
            "TableUpdate<CombatImmunityState>",
            "TableUpdate",
        ).with_cause(e).into()
    })
}
        ...
        #[allow(non_camel_case_types)]
        /// Extension trait for query builder access to the table `CombatImmunityState`.
        ///
        /// Implemented for [`__sdk::QueryTableAccessor`].
        pub trait combat_immunity_stateQueryTableAccess {
            #[allow(non_snake_case)]
            /// Get a query builder for the table `CombatImmunityState`.
            fn combat_immunity_state(&self) -> __sdk::__query_builder::Table<CombatImmunityState>;
        }

        impl combat_immunity_stateQueryTableAccess for __sdk::QueryTableAccessor {
            fn combat_immunity_state(&self) -> __sdk::__query_builder::Table<CombatImmunityState> {
                __sdk::__query_builder::Table::new("combat_immunity_state")
            }
        }
