...
/// Extension trait for access to the reducer `import_resource_growth_recipe_desc`.
///
/// Implemented for [`super::RemoteReducers`].
pub trait import_resource_growth_recipe_desc {
    /// Request that the remote module invoke the reducer `import_resource_growth_recipe_desc` to run as soon as possible.
    ///
    /// This method returns immediately, and errors only if we are unable to send the request.
    /// The reducer will run asynchronously in the future,
    ///  and this method provides no way to listen for its completion status.
    /// /// Use [`import_resource_growth_recipe_desc:import_resource_growth_recipe_desc_then`] to run a callback after the reducer completes.
    fn import_resource_growth_recipe_desc(&self, records: Vec::<ResourceGrowthRecipeDesc>,
) -> __sdk::Result<()> {
        self.import_resource_growth_recipe_desc_then(records,  |_, _| {})
    }
    ...
    fn import_resource_growth_recipe_desc_then(
        &self,
...
impl import_resource_growth_recipe_desc for super::RemoteReducers {
    fn import_resource_growth_recipe_desc_then(
        ...
        self.imp.invoke_reducer_with_callback(ImportResourceGrowthRecipeDescArgs { records,  }, callback)
    }
}
