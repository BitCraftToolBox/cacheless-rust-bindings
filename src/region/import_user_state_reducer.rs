...
pub trait import_user_state {
    ...
    /// /// Use [`import_user_state:import_user_state_then`] to run a callback after the reducer completes.
    fn import_user_state(&self, records: Vec::<UserState>,
) -> __sdk::Result<()> {
        self.import_user_state_then(records,  |_, _| {})
    }
...
impl import_user_state for super::RemoteReducers {
    fn import_user_state_then(
        ...
        self.imp.invoke_reducer_with_callback(ImportUserStateArgs { records,  }, callback)
    }
}
