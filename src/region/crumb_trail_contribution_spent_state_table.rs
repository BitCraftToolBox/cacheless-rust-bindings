...
pub trait CrumbTrailContributionSpentStateTableAccess {
    ...
    fn crumb_trail_contribution_spent_state(&self) -> CrumbTrailContributionSpentStateTableHandle<'_>;
}

impl CrumbTrailContributionSpentStateTableAccess for super::RemoteTables {
    fn crumb_trail_contribution_spent_state(&self) -> CrumbTrailContributionSpentStateTableHandle<'_> {
        CrumbTrailContributionSpentStateTableHandle {
            imp: self.imp.get_table::<CrumbTrailContributionSpentState>("crumb_trail_contribution_spent_state"),
...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        ...
        pub trait crumb_trail_contribution_spent_stateQueryTableAccess {
            ...
            fn crumb_trail_contribution_spent_state(&self) -> __sdk::__query_builder::Table<CrumbTrailContributionSpentState>;
        }
