...
/// Extension trait for access to the reducer `stage_item_conversion_recipe_desc`.
///
/// Implemented for [`super::RemoteReducers`].
pub trait stage_item_conversion_recipe_desc {
    /// Request that the remote module invoke the reducer `stage_item_conversion_recipe_desc` to run as soon as possible.
    ///
    /// This method returns immediately, and errors only if we are unable to send the request.
    /// The reducer will run asynchronously in the future,
    ///  and this method provides no way to listen for its completion status.
    /// /// Use [`stage_item_conversion_recipe_desc:stage_item_conversion_recipe_desc_then`] to run a callback after the reducer completes.
    fn stage_item_conversion_recipe_desc(&self, records: Vec::<ItemConversionRecipeDesc>,
) -> __sdk::Result<()> {
        self.stage_item_conversion_recipe_desc_then(records,  |_, _| {})
    }
    ...
    fn stage_item_conversion_recipe_desc_then(
        &self,
...
impl stage_item_conversion_recipe_desc for super::RemoteReducers {
    fn stage_item_conversion_recipe_desc_then(
        ...
        self.imp.invoke_reducer_with_callback(StageItemConversionRecipeDescArgs { records,  }, callback)
    }
}
