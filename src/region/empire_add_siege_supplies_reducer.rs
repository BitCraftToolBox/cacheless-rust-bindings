...
pub trait empire_add_siege_supplies {
    ...
    /// /// Use [`empire_add_siege_supplies:empire_add_siege_supplies_then`] to run a callback after the reducer completes.
    fn empire_add_siege_supplies(&self, request: EmpireAddSiegeSuppliesRequest,
) -> __sdk::Result<()> {
        self.empire_add_siege_supplies_then(request,  |_, _| {})
    }
    ...
    fn empire_add_siege_supplies_then(
        &self,
...
impl empire_add_siege_supplies for super::RemoteReducers {
    fn empire_add_siege_supplies_then(
        ...
        self.imp.invoke_reducer_with_callback(EmpireAddSiegeSuppliesArgs { request,  }, callback)
    }
}
