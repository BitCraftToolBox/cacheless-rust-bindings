...
pub trait import_resource_placement_recipe_desc {
    ...
    /// /// Use [`import_resource_placement_recipe_desc:import_resource_placement_recipe_desc_then`] to run a callback after the reducer completes.
    fn import_resource_placement_recipe_desc(&self, records: Vec::<ResourcePlacementRecipeDesc>,
) -> __sdk::Result<()> {
        self.import_resource_placement_recipe_desc_then(records,  |_, _| {})
    }
    ...
    fn import_resource_placement_recipe_desc_then(
        &self,
...
impl import_resource_placement_recipe_desc for super::RemoteReducers {
    fn import_resource_placement_recipe_desc_then(
        ...
        self.imp.invoke_reducer_with_callback(ImportResourcePlacementRecipeDescArgs { records,  }, callback)
    }
}
