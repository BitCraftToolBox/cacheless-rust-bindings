...
pub struct TheGreatPlaceHolderTableCols {
    ...
    pub placeholder_buff_category: __sdk::__query_builder::Col<TheGreatPlaceHolderTable, BuffCategory>,
    pub placeholder: __sdk::__query_builder::Col<TheGreatPlaceHolderTable, ProgressiveActionStatus>,
    pub placeholder_water_body_type: __sdk::__query_builder::Col<TheGreatPlaceHolderTable, SurfaceType>,
...
impl __sdk::__query_builder::HasCols for TheGreatPlaceHolderTable {
    ...
    fn cols(table_name: &'static str) -> Self::Cols {
        TheGreatPlaceHolderTableCols {
            ...
            placeholder_skill_type: __sdk::__query_builder::Col::new(table_name, "placeholder_skill_type"),
            placeholder_buff_category: __sdk::__query_builder::Col::new(table_name, "placeholder_buff_category"),
            placeholder: __sdk::__query_builder::Col::new(table_name, "placeholder"),
            placeholder_water_body_type: __sdk::__query_builder::Col::new(table_name, "placeholder_water_body_type"),
