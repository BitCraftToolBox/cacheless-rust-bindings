...
/// Table handle for the table `knowledge_vault_state`.
///
/// Obtain a handle from the [`KnowledgeVaultStateTableAccess::knowledge_vault_state`] method on [`super::RemoteTables`],
/// like `ctx.db.knowledge_vault_state()`.
///
/// Users are encouraged not to explicitly reference this type,
/// but to directly chain method calls,
/// like `ctx.db.knowledge_vault_state().on_insert(...)`.
pub struct KnowledgeVaultStateTableHandle<'ctx> {
    imp: __sdk::TableHandle<KnowledgeVaultState>,
...
pub trait KnowledgeVaultStateTableAccess {
    #[allow(non_snake_case)]
    /// Obtain a [`KnowledgeVaultStateTableHandle`], which mediates access to the table `knowledge_vault_state`.
    fn knowledge_vault_state(&self) -> KnowledgeVaultStateTableHandle<'_>;
}

impl KnowledgeVaultStateTableAccess for super::RemoteTables {
    fn knowledge_vault_state(&self) -> KnowledgeVaultStateTableHandle<'_> {
        KnowledgeVaultStateTableHandle {
            imp: self.imp.get_table::<KnowledgeVaultState>("knowledge_vault_state"),
...
impl<'ctx> __sdk::TableLike for KnowledgeVaultStateTableHandle<'ctx> {
    ...
    fn iter(&self) -> impl Iterator<Item = KnowledgeVaultState> + '_ { self.imp.iter() }
}
...
impl<'ctx> __sdk::WithUpdate for KnowledgeVaultStateTableHandle<'ctx> {
    ...
    fn remove_on_update(&self, callback: KnowledgeVaultStateUpdateCallbackId) {
        ...
        /// via the [`KnowledgeVaultStateEntityIdUnique::find`] method.
        ///
        /// Users are encouraged not to explicitly reference this type,
        /// but to directly chain method calls,
        /// like `ctx.db.knowledge_vault_state().entity_id().find(...)`.
        pub struct KnowledgeVaultStateEntityIdUnique<'ctx> {
            imp: __sdk::UniqueConstraintHandle<KnowledgeVaultState, u64>,
            phantom: std::marker::PhantomData<&'ctx super::RemoteTables>,
        }

        impl<'ctx> KnowledgeVaultStateTableHandle<'ctx> {
            /// Get a handle on the `entity_id` unique index on the table `knowledge_vault_state`.
            pub fn entity_id(&self) -> KnowledgeVaultStateEntityIdUnique<'ctx> {
                KnowledgeVaultStateEntityIdUnique {
        ...
        impl<'ctx> KnowledgeVaultStateEntityIdUnique<'ctx> {
...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        __sdk::InternalError::failed_parse(
            "TableUpdate<KnowledgeVaultState>",
            "TableUpdate",
        ).with_cause(e).into()
    })
}
        ...
        #[allow(non_camel_case_types)]
        /// Extension trait for query builder access to the table `KnowledgeVaultState`.
        ///
        /// Implemented for [`__sdk::QueryTableAccessor`].
        pub trait knowledge_vault_stateQueryTableAccess {
            #[allow(non_snake_case)]
            /// Get a query builder for the table `KnowledgeVaultState`.
            fn knowledge_vault_state(&self) -> __sdk::__query_builder::Table<KnowledgeVaultState>;
        }

        impl knowledge_vault_stateQueryTableAccess for __sdk::QueryTableAccessor {
            fn knowledge_vault_state(&self) -> __sdk::__query_builder::Table<KnowledgeVaultState> {
                __sdk::__query_builder::Table::new("knowledge_vault_state")
            }
        }
