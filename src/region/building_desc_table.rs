...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        ...
        pub trait building_descQueryTableAccess {
            #[allow(non_snake_case)]
            /// Get a query builder for the table `BuildingDesc`.
            fn building_desc(&self) -> __sdk::__query_builder::Table<BuildingDesc>;
        }

        impl building_descQueryTableAccess for __sdk::QueryTableAccessor {
            fn building_desc(&self) -> __sdk::__query_builder::Table<BuildingDesc> {
                __sdk::__query_builder::Table::new("building_desc")
            }
        }
