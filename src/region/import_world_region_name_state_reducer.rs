...
pub trait import_world_region_name_state {
    ...
    fn import_world_region_name_state(&self, records: Vec::<WorldRegionNameState>,
) -> __sdk::Result<()> {
...
impl import_world_region_name_state for super::RemoteReducers {
    fn import_world_region_name_state_then(
        ...
        self.imp.invoke_reducer_with_callback(ImportWorldRegionNameStateArgs { records,  }, callback)
    }
}
