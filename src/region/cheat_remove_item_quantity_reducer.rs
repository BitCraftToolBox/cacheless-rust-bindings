...
pub trait cheat_remove_item_quantity {
    ...
    fn cheat_remove_item_quantity(&self, inventory_entity_id: u64,
pocket_index: i32,
quantity_to_remove: i32,
) -> __sdk::Result<()> {
        self.cheat_remove_item_quantity_then(inventory_entity_id, pocket_index, quantity_to_remove,  |_, _| {})
    }
...
quantity_to_remove: i32,
        ...
        self.imp.invoke_reducer_with_callback(CheatRemoveItemQuantityArgs { inventory_entity_id, pocket_index, quantity_to_remove,  }, callback)
    }
}
