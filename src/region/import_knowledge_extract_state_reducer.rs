...
#[sats(crate = __lib)]
pub(super) struct ImportKnowledgeExtractStateArgs {
    pub records: Vec::<KnowledgeExtractState>,
}

impl From<ImportKnowledgeExtractStateArgs> for super::Reducer {
    fn from(args: ImportKnowledgeExtractStateArgs) -> Self {
        Self::ImportKnowledgeExtractState {
            records: args.records,
}
}
}

impl __sdk::InModule for ImportKnowledgeExtractStateArgs {
...
pub trait import_knowledge_extract_state {
    ...
    fn import_knowledge_extract_state(&self, records: Vec::<KnowledgeExtractState>,
) -> __sdk::Result<()> {
...
impl import_knowledge_extract_state for super::RemoteReducers {
    fn import_knowledge_extract_state_then(
        ...
        self.imp.invoke_reducer_with_callback(ImportKnowledgeExtractStateArgs { records,  }, callback)
    }
}
