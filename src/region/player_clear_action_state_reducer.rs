...
last_action_result: PlayerActionResult,
        ...
        self.player_clear_action_state_then(actor_id, current_action, layer, last_action_result,  |_, _| {})
    }
...
last_action_result: PlayerActionResult,
        ...
        self.imp.invoke_reducer_with_callback(PlayerClearActionStateArgs { actor_id, current_action, layer, last_action_result,  }, callback)
    }
}
