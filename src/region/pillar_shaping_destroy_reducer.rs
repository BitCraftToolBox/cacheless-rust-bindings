...
pub trait pillar_shaping_destroy {
    ...
    fn pillar_shaping_destroy(&self, request: PlayerPillarShapingDestroyRequest,
) -> __sdk::Result<()> {
...
impl pillar_shaping_destroy for super::RemoteReducers {
    fn pillar_shaping_destroy_then(
        ...
        self.imp.invoke_reducer_with_callback(PillarShapingDestroyArgs { request,  }, callback)
    }
}
