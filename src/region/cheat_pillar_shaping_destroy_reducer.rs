...
#[sats(crate = __lib)]
pub(super) struct CheatPillarShapingDestroyArgs {
    pub request: PlayerPillarShapingDestroyRequest,
}

impl From<CheatPillarShapingDestroyArgs> for super::Reducer {
...
pub trait cheat_pillar_shaping_destroy {
...
impl cheat_pillar_shaping_destroy for super::RemoteReducers {
    fn cheat_pillar_shaping_destroy_then(
        ...
        self.imp.invoke_reducer_with_callback(CheatPillarShapingDestroyArgs { request,  }, callback)
    }
}
