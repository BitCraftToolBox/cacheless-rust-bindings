...
impl __sdk::__query_builder::HasCols for TerraformProgressState {
    ...
    fn cols(table_name: &'static str) -> Self::Cols {
        TerraformProgressStateCols {
            ...
            final_height_target: __sdk::__query_builder::Col::new(table_name, "final_height_target"),
...
impl __sdk::__query_builder::CanBeLookupTable for TerraformProgressState {}
