...
pub trait import_interior_portal_connections_desc {
    ...
    /// /// Use [`import_interior_portal_connections_desc:import_interior_portal_connections_desc_then`] to run a callback after the reducer completes.
    fn import_interior_portal_connections_desc(&self, records: Vec::<InteriorPortalConnectionsDesc>,
) -> __sdk::Result<()> {
        self.import_interior_portal_connections_desc_then(records,  |_, _| {})
    }
    ...
    fn import_interior_portal_connections_desc_then(
        &self,
...
impl import_interior_portal_connections_desc for super::RemoteReducers {
    fn import_interior_portal_connections_desc_then(
        ...
        self.imp.invoke_reducer_with_callback(ImportInteriorPortalConnectionsDescArgs { records,  }, callback)
    }
}
