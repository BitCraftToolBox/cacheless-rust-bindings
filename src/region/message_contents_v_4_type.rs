...
use super::empire_withdraw_item_msg_type::EmpireWithdrawItemMsg;
use super::on_deployable_recovered_msg_v_2_type::OnDeployableRecoveredMsgV2;
use super::inter_module_table_updates_v_2_type::InterModuleTableUpdatesV2;
use super::transfer_player_msg_v_4_type::TransferPlayerMsgV4;
...
impl __sdk::InModule for MessageContentsV4 {
