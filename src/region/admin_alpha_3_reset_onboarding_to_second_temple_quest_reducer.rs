...
pub trait admin_alpha_3_reset_onboarding_to_second_temple_quest {
    ...
    /// /// Use [`admin_alpha_3_reset_onboarding_to_second_temple_quest:admin_alpha_3_reset_onboarding_to_second_temple_quest_then`] to run a callback after the reducer completes.
    fn admin_alpha_3_reset_onboarding_to_second_temple_quest(&self, entity_id: u64,
) -> __sdk::Result<()> {
        self.admin_alpha_3_reset_onboarding_to_second_temple_quest_then(entity_id,  |_, _| {})
    }
    ...
    fn admin_alpha_3_reset_onboarding_to_second_temple_quest_then(
        &self,
        entity_id: u64,
...
impl admin_alpha_3_reset_onboarding_to_second_temple_quest for super::RemoteReducers {
    fn admin_alpha_3_reset_onboarding_to_second_temple_quest_then(
        ...
        self.imp.invoke_reducer_with_callback(AdminAlpha3ResetOnboardingToSecondTempleQuestArgs { entity_id,  }, callback)
    }
}
