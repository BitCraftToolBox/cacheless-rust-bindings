...
pub trait stage_knowledge_stat_modifier_desc {
    ...
    /// /// Use [`stage_knowledge_stat_modifier_desc:stage_knowledge_stat_modifier_desc_then`] to run a callback after the reducer completes.
    fn stage_knowledge_stat_modifier_desc(&self, records: Vec::<KnowledgeStatModifierDesc>,
) -> __sdk::Result<()> {
        self.stage_knowledge_stat_modifier_desc_then(records,  |_, _| {})
    }
    ...
    fn stage_knowledge_stat_modifier_desc_then(
        &self,
...
impl stage_knowledge_stat_modifier_desc for super::RemoteReducers {
    fn stage_knowledge_stat_modifier_desc_then(
        ...
        self.imp.invoke_reducer_with_callback(StageKnowledgeStatModifierDescArgs { records,  }, callback)
    }
}
