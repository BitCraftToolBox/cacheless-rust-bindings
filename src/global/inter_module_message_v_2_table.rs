...
impl InterModuleMessageV2TableAccess for super::RemoteTables {
    fn inter_module_message_v_2(&self) -> InterModuleMessageV2TableHandle<'_> {
        InterModuleMessageV2TableHandle {
            imp: self.imp.get_table::<InterModuleMessageV2>("inter_module_message_v2"),
...
impl<'ctx> __sdk::TableLike for InterModuleMessageV2TableHandle<'ctx> {
    ...
    fn iter(&self) -> impl Iterator<Item = InterModuleMessageV2> + '_ { self.imp.iter() }
}
...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        __sdk::InternalError::failed_parse(
            "TableUpdate<InterModuleMessageV2>",
            "TableUpdate",
        ).with_cause(e).into()
    })
}
