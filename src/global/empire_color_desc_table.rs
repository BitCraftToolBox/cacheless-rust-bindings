...
///
/// Obtain a handle from the [`EmpireColorDescTableAccess::empire_color_desc`] method on [`super::RemoteTables`],
/// like `ctx.db.empire_color_desc()`.
///
/// Users are encouraged not to explicitly reference this type,
/// but to directly chain method calls,
/// like `ctx.db.empire_color_desc().on_insert(...)`.
...
pub trait EmpireColorDescTableAccess {
    #[allow(non_snake_case)]
    /// Obtain a [`EmpireColorDescTableHandle`], which mediates access to the table `empire_color_desc`.
    fn empire_color_desc(&self) -> EmpireColorDescTableHandle<'_>;
}

impl EmpireColorDescTableAccess for super::RemoteTables {
    fn empire_color_desc(&self) -> EmpireColorDescTableHandle<'_> {
        EmpireColorDescTableHandle {
            imp: self.imp.get_table::<EmpireColorDesc>("empire_color_desc"),
