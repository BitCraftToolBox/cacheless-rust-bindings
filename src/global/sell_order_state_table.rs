...
/// Lifetime-aware accessor marker for the table `sell_order_state`.
pub struct SellOrderStateTableAccessor;

impl __sdk::TableAccessor<super::RemoteTables> for SellOrderStateTableAccessor {
    type Row = AuctionListingState;
    type Handle<'db> = SellOrderStateTableHandle<'db>;
...
impl SellOrderStateTableAccess for super::RemoteTables {
    fn sell_order_state(&self) -> SellOrderStateTableHandle<'_> {
        SellOrderStateTableHandle {
            imp: self.imp.get_table::<AuctionListingState>("sell_order_state"),
...
impl<'ctx> __sdk::TableLike for SellOrderStateTableHandle<'ctx> {
    type Row = AuctionListingState;
    type EventContext = super::EventContext;

    fn count(&self) -> u64 { self.imp.count() }
    fn iter(&self) -> impl Iterator<Item = AuctionListingState> + '_ { self.imp.iter() }
}
...
impl<'ctx> __sdk::WithInsert for SellOrderStateTableHandle<'ctx> {
    type InsertCallbackId = SellOrderStateInsertCallbackId;
...
impl<'ctx> __sdk::WithDelete for SellOrderStateTableHandle<'ctx> {
    type DeleteCallbackId = SellOrderStateDeleteCallbackId;
...
impl<'ctx> __sdk::WithUpdate for SellOrderStateTableHandle<'ctx> {
    type UpdateCallbackId = SellOrderStateUpdateCallbackId;
...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        __sdk::InternalError::failed_parse(
            "TableUpdate<AuctionListingState>",
            "TableUpdate",
        ).with_cause(e).into()
    })
}
        ...
        #[allow(non_camel_case_types)]
        /// Extension trait for query builder access to the table `AuctionListingState`.
        ///
        /// Implemented for [`__sdk::QueryTableAccessor`].
        pub trait sell_order_stateQueryTableAccess {
            #[allow(non_snake_case)]
            /// Get a query builder for the table `AuctionListingState`.
            fn sell_order_state(&self) -> __sdk::__query_builder::Table<AuctionListingState>;
        }

        impl sell_order_stateQueryTableAccess for __sdk::QueryTableAccessor {
            fn sell_order_state(&self) -> __sdk::__query_builder::Table<AuctionListingState> {
                __sdk::__query_builder::Table::new("sell_order_state")
            }
        }
