...
pub struct ForceGenerateTypesCols {
    ...
    pub empire_permission: __sdk::__query_builder::Col<ForceGenerateTypes, EmpirePermission>,
...
impl __sdk::__query_builder::HasCols for ForceGenerateTypes {
    ...
    fn cols(table_name: &'static str) -> Self::Cols {
        ForceGenerateTypesCols {
            ...
            empire_permission: __sdk::__query_builder::Col::new(table_name, "empire_permission"),
