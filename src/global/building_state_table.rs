...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        ...
        #[allow(non_camel_case_types)]
        /// Extension trait for query builder access to the table `BuildingState`.
        ///
        /// Implemented for [`__sdk::QueryTableAccessor`].
        pub trait building_stateQueryTableAccess {
            #[allow(non_snake_case)]
            /// Get a query builder for the table `BuildingState`.
            fn building_state(&self) -> __sdk::__query_builder::Table<BuildingState>;
        }

        impl building_stateQueryTableAccess for __sdk::QueryTableAccessor {
            fn building_state(&self) -> __sdk::__query_builder::Table<BuildingState> {
                __sdk::__query_builder::Table::new("building_state")
            }
        }
