...
pub struct AdminRenamePlayerEntityCallbackId(__sdk::CallbackId);
...
#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `admin_rename_player_entity`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_admin_rename_player_entity {
    /// Set the call-reducer flags for the reducer `admin_rename_player_entity` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
