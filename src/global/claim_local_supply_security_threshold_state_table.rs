...
impl __sdk::TableAccessor<super::RemoteTables> for ClaimLocalSupplySecurityThresholdStateTableAccessor {
...
pub trait ClaimLocalSupplySecurityThresholdStateTableAccess {
    ...
    fn claim_local_supply_security_threshold_state(&self) -> ClaimLocalSupplySecurityThresholdStateTableHandle<'_>;
}
...
impl ClaimLocalSupplySecurityThresholdStateTableAccess for super::RemoteTables {
    fn claim_local_supply_security_threshold_state(&self) -> ClaimLocalSupplySecurityThresholdStateTableHandle<'_> {
        ClaimLocalSupplySecurityThresholdStateTableHandle {
            imp: self.imp.get_table::<ClaimLocalSupplySecurityThresholdState>("claim_local_supply_security_threshold_state"),
...
impl<'ctx> __sdk::Table for ClaimLocalSupplySecurityThresholdStateTableHandle<'ctx> {
    ...
    fn on_insert(
        ...
        ClaimLocalSupplySecurityThresholdStateInsertCallbackId(self.imp.on_insert(Box::new(callback)))
    }
    ...
    fn on_delete(
        ...
        ClaimLocalSupplySecurityThresholdStateDeleteCallbackId(self.imp.on_delete(Box::new(callback)))
    }
...
impl<'ctx> __sdk::TableWithPrimaryKey for ClaimLocalSupplySecurityThresholdStateTableHandle<'ctx> {
    ...
    fn on_update(
        ...
        ClaimLocalSupplySecurityThresholdStateUpdateCallbackId(self.imp.on_update(Box::new(callback)))
    }
...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        ...
        pub trait claim_local_supply_security_threshold_stateQueryTableAccess {
            ...
            fn claim_local_supply_security_threshold_state(&self) -> __sdk::__query_builder::Table<ClaimLocalSupplySecurityThresholdState>;
        }
