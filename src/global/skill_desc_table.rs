...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        ...
        pub trait skill_descQueryTableAccess {
            #[allow(non_snake_case)]
            /// Get a query builder for the table `SkillDesc`.
            fn skill_desc(&self) -> __sdk::__query_builder::Table<SkillDesc>;
        }

        impl skill_descQueryTableAccess for __sdk::QueryTableAccessor {
            fn skill_desc(&self) -> __sdk::__query_builder::Table<SkillDesc> {
                __sdk::__query_builder::Table::new("skill_desc")
            }
        }
