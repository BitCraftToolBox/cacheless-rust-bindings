...
///
/// Obtain a handle from the [`InteriorNetworkDescTableAccess::interior_network_desc`] method on [`super::RemoteTables`],
/// like `ctx.db.interior_network_desc()`.
///
/// Users are encouraged not to explicitly reference this type,
/// but to directly chain method calls,
/// like `ctx.db.interior_network_desc().on_insert(...)`.
pub struct InteriorNetworkDescTableHandle<'ctx> {
...
pub trait InteriorNetworkDescTableAccess {
    #[allow(non_snake_case)]
    /// Obtain a [`InteriorNetworkDescTableHandle`], which mediates access to the table `interior_network_desc`.
...
pub trait interior_network_descQueryTableAccess {
    #[allow(non_snake_case)]
    /// Get a query builder for the table `InteriorNetworkDesc`.
    fn interior_network_desc(&self) -> __sdk::__query_builder::Table<InteriorNetworkDesc>;
}

impl interior_network_descQueryTableAccess for __sdk::QueryTableAccessor {
    fn interior_network_desc(&self) -> __sdk::__query_builder::Table<InteriorNetworkDesc> {
        __sdk::__query_builder::Table::new("interior_network_desc")
    }
}
