...
#[sats(crate = __lib)]
pub(super) struct ImportEquipmentStateArgs {
    pub records: Vec::<EquipmentState>,
}

impl From<ImportEquipmentStateArgs> for super::Reducer {
    fn from(args: ImportEquipmentStateArgs) -> Self {
        Self::ImportEquipmentState {
            records: args.records,
}
}
}

impl __sdk::InModule for ImportEquipmentStateArgs {
...
pub trait import_equipment_state {
    ...
    fn import_equipment_state(&self, records: Vec::<EquipmentState>,
) -> __sdk::Result<()> {
...
impl import_equipment_state for super::RemoteReducers {
    fn import_equipment_state_then(
        ...
        self.imp.invoke_reducer_with_callback(ImportEquipmentStateArgs { records,  }, callback)
    }
}
