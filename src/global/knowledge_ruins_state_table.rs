...
impl KnowledgeRuinsStateTableAccess for super::RemoteTables {
    fn knowledge_ruins_state(&self) -> KnowledgeRuinsStateTableHandle<'_> {
        KnowledgeRuinsStateTableHandle {
            imp: self.imp.get_table::<KnowledgeRuinsState>("knowledge_ruins_state"),
...
impl<'ctx> __sdk::TableLike for KnowledgeRuinsStateTableHandle<'ctx> {
    ...
    fn iter(&self) -> impl Iterator<Item = KnowledgeRuinsState> + '_ { self.imp.iter() }
}
...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        __sdk::InternalError::failed_parse(
            "TableUpdate<KnowledgeRuinsState>",
            "TableUpdate",
        ).with_cause(e).into()
    })
}
