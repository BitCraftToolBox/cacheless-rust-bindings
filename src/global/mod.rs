    ...
    fn try_from(raw: __ws::v2::TransactionUpdate) -> Result<Self, Self::Error> {
        ...
        for table_update in __sdk::transaction_update_iter_table_updates(raw) {
            match &table_update.table_name[..] {
                ...
                "blocked_player_state" => db_update.blocked_player_state.append(
                    blocked_player_state_table::parse_table_update(table_update)?,
                ),
                "buff_desc" => db_update
                    .buff_desc
                ...
                "direct_message_state" => db_update.direct_message_state.append(
                    direct_message_state_table::parse_table_update(table_update)?,
                ),
                ...
                "empire_directive_state" => db_update.empire_directive_state.append(
                    empire_directive_state_table::parse_table_update(table_update)?,
                ),
                "empire_emblem_state" => db_update
                    .empire_emblem_state
                    .append(empire_emblem_state_table::parse_table_update(table_update)?),
                "empire_foundry_state" => db_update.empire_foundry_state.append(
                ...
                "empire_notification_state" => db_update.empire_notification_state.append(
                ...
                "empire_player_log_state" => db_update.empire_player_log_state.append(
                ...
                "empire_siege_engine_state" => db_update.empire_siege_engine_state.append(
                ...
                "friends_state" => db_update
                    .friends_state
                    .append(friends_state_table::parse_table_update(table_update)?),
                "gate_desc" => db_update
                    .gate_desc
                ...
                "premium_purchase_state" => db_update.premium_purchase_state.append(
                    premium_purchase_state_table::parse_table_update(table_update)?,
                ),
                "premium_service_desc" => db_update.premium_service_desc.append(
                    premium_service_desc_table::parse_table_update(table_update)?,
                ),
                "previous_empire_name" => db_update.previous_empire_name.append(
                    previous_empire_name_table::parse_table_update(table_update)?,
                ),
                "previous_player_skills" => db_update.previous_player_skills.append(
                    previous_player_skills_table::parse_table_update(table_update)?,
                ),
                "previous_username" => db_update
                    .previous_username
                    .append(previous_username_table::parse_table_update(table_update)?),
                ...
                "user_region_state" => db_update
                    .user_region_state
                    .append(user_region_state_table::parse_table_update(table_update)?),
                ...
                "visibility_state" => db_update
                    .visibility_state
                    .append(visibility_state_table::parse_table_update(table_update)?),
                "wall_desc" => db_update
                    .wall_desc
        ...
        for table_rows in raw.tables {
            match &table_rows.table[..] {
                ...
                "biome_desc" => db_update
                    .biome_desc
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "blocked_player_state" => db_update
                    .blocked_player_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "buff_desc" => db_update
                    .buff_desc
                ...
                "character_stats_state" => db_update
                    .character_stats_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "chat_channel_permission_state" => db_update
                    .chat_channel_permission_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "chat_channel_state" => db_update
                    .chat_channel_state
                ...
                "dimension_network_state" => db_update
                    .dimension_network_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "direct_message_state" => db_update
                    .direct_message_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                ...
                "empire_color_desc" => db_update
                    .empire_color_desc
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "empire_directive_state" => db_update
                    .empire_directive_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "empire_emblem_state" => db_update
                    .empire_emblem_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "empire_foundry_state" => db_update
                    .empire_foundry_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "empire_icon_desc" => db_update
                    .empire_icon_desc
                ...
                "empire_notification_desc" => db_update
                    .empire_notification_desc
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "empire_notification_state" => db_update
                    .empire_notification_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "empire_player_data_state" => db_update
                    .empire_player_data_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "empire_player_log_state" => db_update
                    .empire_player_log_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "empire_rank_desc" => db_update
                    .empire_rank_desc
                ...
                "empire_settlement_state" => db_update
                    .empire_settlement_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "empire_siege_engine_state" => db_update
                    .empire_siege_engine_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "empire_state" => db_update
                    .empire_state
                ...
                "marketplace_state" => db_update
                    .marketplace_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "minimum_client_version" => db_update
                    .minimum_client_version
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "mobile_entity_state" => db_update
                    .mobile_entity_state
                ...
                "npc_state" => db_update
                    .npc_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "official_translators" => db_update
                    .official_translators
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                ...
                "player_action_state" => db_update
                    .player_action_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "player_developer_notification_state" => db_update
                    .player_developer_notification_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                ...
                "premium_item_desc" => db_update
                    .premium_item_desc
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "premium_purchase_state" => db_update
                    .premium_purchase_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "premium_service_desc" => db_update
                    .premium_service_desc
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "previous_empire_name" => db_update
                    .previous_empire_name
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "previous_player_skills" => db_update
                    .previous_player_skills
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "previous_username" => db_update
                    .previous_username
                ...
                "trade_session_state" => db_update
                    .trade_session_state
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "translation_corrections" => db_update
                    .translation_corrections
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
