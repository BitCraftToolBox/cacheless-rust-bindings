...
impl DistantVisibleEntityDescTableAccess for super::RemoteTables {
    fn distant_visible_entity_desc(&self) -> DistantVisibleEntityDescTableHandle<'_> {
        DistantVisibleEntityDescTableHandle {
            imp: self.imp.get_table::<DistantVisibleEntityDesc>("distant_visible_entity_desc"),
...
impl<'ctx> __sdk::TableLike for DistantVisibleEntityDescTableHandle<'ctx> {
    ...
    fn iter(&self) -> impl Iterator<Item = DistantVisibleEntityDesc> + '_ { self.imp.iter() }
}
...
pub(super) fn register_table(client_cache: &mut __sdk::ClientCache<super::RemoteModule>) {
    ...
    let _table = client_cache.get_or_make_table::<DistantVisibleEntityDesc>("distant_visible_entity_desc");
...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        __sdk::InternalError::failed_parse(
            "TableUpdate<DistantVisibleEntityDesc>",
            "TableUpdate",
        ).with_cause(e).into()
    })
}
        ...
        pub trait distant_visible_entity_descQueryTableAccess {
            ...
            fn distant_visible_entity_desc(&self) -> __sdk::__query_builder::Table<DistantVisibleEntityDesc>;
        }
