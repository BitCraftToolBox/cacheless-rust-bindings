...
impl TravelerTaskCreditStateTableAccess for super::RemoteTables {
    fn traveler_task_credit_state(&self) -> TravelerTaskCreditStateTableHandle<'_> {
        TravelerTaskCreditStateTableHandle {
            imp: self.imp.get_table::<TravelerTaskCreditState>("traveler_task_credit_state"),
...
impl<'ctx> __sdk::TableLike for TravelerTaskCreditStateTableHandle<'ctx> {
    ...
    fn iter(&self) -> impl Iterator<Item = TravelerTaskCreditState> + '_ { self.imp.iter() }
}
...
pub(super) fn register_table(client_cache: &mut __sdk::ClientCache<super::RemoteModule>) {
    ...
    let _table = client_cache.get_or_make_table::<TravelerTaskCreditState>("traveler_task_credit_state");
...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        __sdk::InternalError::failed_parse(
            "TableUpdate<TravelerTaskCreditState>",
            "TableUpdate",
        ).with_cause(e).into()
    })
}
