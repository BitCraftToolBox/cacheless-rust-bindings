...
#[sats(crate = __lib)]
pub(super) struct UnbanPlayerFromChatChannelArgs {
    pub channel_entity_id: u64,
    pub player_entity_id: u64,
}

impl From<UnbanPlayerFromChatChannelArgs> for super::Reducer {
    fn from(args: UnbanPlayerFromChatChannelArgs) -> Self {
        Self::UnbanPlayerFromChatChannel {
...
impl __sdk::InModule for UnbanPlayerFromChatChannelArgs {
...
pub trait unban_player_from_chat_channel {
    ...
    fn unban_player_from_chat_channel(&self, channel_entity_id: u64,
...
player_entity_id: u64,
        ...
        self.imp.invoke_reducer_with_callback(UnbanPlayerFromChatChannelArgs { channel_entity_id, player_entity_id,  }, callback)
    }
}
