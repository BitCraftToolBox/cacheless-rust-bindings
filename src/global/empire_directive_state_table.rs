...
use super::empire_directive_state_type::EmpireDirectiveState;

/// Table handle for the table `empire_directive_state`.
///
/// Obtain a handle from the [`EmpireDirectiveStateTableAccess::empire_directive_state`] method on [`super::RemoteTables`],
/// like `ctx.db.empire_directive_state()`.
///
/// Users are encouraged not to explicitly reference this type,
/// but to directly chain method calls,
/// like `ctx.db.empire_directive_state().on_insert(...)`.
pub struct EmpireDirectiveStateTableHandle<'ctx> {
    imp: __sdk::TableHandle<EmpireDirectiveState>,
...
pub trait EmpireDirectiveStateTableAccess {
    #[allow(non_snake_case)]
    /// Obtain a [`EmpireDirectiveStateTableHandle`], which mediates access to the table `empire_directive_state`.
    fn empire_directive_state(&self) -> EmpireDirectiveStateTableHandle<'_>;
}

impl EmpireDirectiveStateTableAccess for super::RemoteTables {
    fn empire_directive_state(&self) -> EmpireDirectiveStateTableHandle<'_> {
        EmpireDirectiveStateTableHandle {
            imp: self.imp.get_table::<EmpireDirectiveState>("empire_directive_state"),
...
impl<'ctx> __sdk::TableLike for EmpireDirectiveStateTableHandle<'ctx> {
    ...
    fn iter(&self) -> impl Iterator<Item = EmpireDirectiveState> + '_ { self.imp.iter() }
}
...
impl<'ctx> __sdk::WithUpdate for EmpireDirectiveStateTableHandle<'ctx> {
    ...
    fn remove_on_update(&self, callback: EmpireDirectiveStateUpdateCallbackId) {
        ...
        /// via the [`EmpireDirectiveStateEntityIdUnique::find`] method.
        ///
        /// Users are encouraged not to explicitly reference this type,
        /// but to directly chain method calls,
        /// like `ctx.db.empire_directive_state().entity_id().find(...)`.
        pub struct EmpireDirectiveStateEntityIdUnique<'ctx> {
            imp: __sdk::UniqueConstraintHandle<EmpireDirectiveState, u64>,
            phantom: std::marker::PhantomData<&'ctx super::RemoteTables>,
        }

        impl<'ctx> EmpireDirectiveStateTableHandle<'ctx> {
            /// Get a handle on the `entity_id` unique index on the table `empire_directive_state`.
            pub fn entity_id(&self) -> EmpireDirectiveStateEntityIdUnique<'ctx> {
                EmpireDirectiveStateEntityIdUnique {
        ...
        impl<'ctx> EmpireDirectiveStateEntityIdUnique<'ctx> {
...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        __sdk::InternalError::failed_parse(
            "TableUpdate<EmpireDirectiveState>",
            "TableUpdate",
        ).with_cause(e).into()
    })
}
