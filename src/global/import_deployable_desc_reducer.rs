...
pub(super) struct ImportDeployableDescArgs {
    pub records: Vec<DeployableDescV4>,
}
...
pub struct ImportDeployableDescCallbackId(__sdk::CallbackId);

#[allow(non_camel_case_types)]
/// Extension trait for access to the reducer `import_deployable_desc`.
///
/// Implemented for [`super::RemoteReducers`].
pub trait import_deployable_desc {
    /// Request that the remote module invoke the reducer `import_deployable_desc` to run as soon as possible.
    ///
    /// This method returns immediately, and errors only if we are unable to send the request.
    /// The reducer will run asynchronously in the future,
    ///  and its status can be observed by listening for [`Self::on_import_deployable_desc`] callbacks.
    fn import_deployable_desc(&self, records: Vec<DeployableDescV4>) -> __sdk::Result<()>;
    ...
    fn on_import_deployable_desc(
        &self,
        callback: impl FnMut(&super::ReducerEventContext, &Vec<DeployableDescV4>) + Send + 'static,
...
impl import_deployable_desc for super::RemoteReducers {
    ...
    fn on_import_deployable_desc(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &Vec<DeployableDescV4>) + Send + 'static,
    ) -> ImportDeployableDescCallbackId {
...
#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `import_deployable_desc`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_import_deployable_desc {
    /// Set the call-reducer flags for the reducer `import_deployable_desc` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
