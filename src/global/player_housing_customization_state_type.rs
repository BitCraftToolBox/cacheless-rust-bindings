...
impl __sdk::__query_builder::HasCols for PlayerHousingCustomizationState {
    ...
    fn cols(table_name: &'static str) -> Self::Cols {
        PlayerHousingCustomizationStateCols {
            ...
            wall_collectible_id: __sdk::__query_builder::Col::new(table_name, "wall_collectible_id"),
            floor_collectible_id: __sdk::__query_builder::Col::new(table_name, "floor_collectible_id"),
...
impl __sdk::__query_builder::CanBeLookupTable for PlayerHousingCustomizationState {}
