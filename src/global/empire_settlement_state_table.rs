...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        ...
        #[allow(non_camel_case_types)]
        /// Extension trait for query builder access to the table `EmpireSettlementState`.
        ///
        /// Implemented for [`__sdk::QueryTableAccessor`].
        pub trait empire_settlement_stateQueryTableAccess {
            #[allow(non_snake_case)]
            /// Get a query builder for the table `EmpireSettlementState`.
            fn empire_settlement_state(&self) -> __sdk::__query_builder::Table<EmpireSettlementState>;
        }

        impl empire_settlement_stateQueryTableAccess for __sdk::QueryTableAccessor {
            fn empire_settlement_state(&self) -> __sdk::__query_builder::Table<EmpireSettlementState> {
                __sdk::__query_builder::Table::new("empire_settlement_state")
            }
        }
