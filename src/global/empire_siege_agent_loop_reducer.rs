...
#[sats(crate = __lib)]
pub(super) struct EmpireSiegeAgentLoopArgs {
    pub timer: EmpireSiegeLoopTimer,
}
...
pub struct EmpireSiegeAgentLoopCallbackId(__sdk::CallbackId);

#[allow(non_camel_case_types)]
/// Extension trait for access to the reducer `empire_siege_agent_loop`.
///
/// Implemented for [`super::RemoteReducers`].
pub trait empire_siege_agent_loop {
    /// Request that the remote module invoke the reducer `empire_siege_agent_loop` to run as soon as possible.
    ///
...
#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `empire_siege_agent_loop`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_empire_siege_agent_loop {
    /// Set the call-reducer flags for the reducer `empire_siege_agent_loop` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
