...
///
/// Obtain a handle from the [`ReservedNameDescTableAccess::reserved_name_desc`] method on [`super::RemoteTables`],
/// like `ctx.db.reserved_name_desc()`.
///
/// Users are encouraged not to explicitly reference this type,
/// but to directly chain method calls,
/// like `ctx.db.reserved_name_desc().on_insert(...)`.
pub struct ReservedNameDescTableHandle<'ctx> {
...
pub trait ReservedNameDescTableAccess {
    #[allow(non_snake_case)]
    /// Obtain a [`ReservedNameDescTableHandle`], which mediates access to the table `reserved_name_desc`.
    fn reserved_name_desc(&self) -> ReservedNameDescTableHandle<'_>;
}

impl ReservedNameDescTableAccess for super::RemoteTables {
    fn reserved_name_desc(&self) -> ReservedNameDescTableHandle<'_> {
        ReservedNameDescTableHandle {
            imp: self.imp.get_table::<ReservedNameDesc>("reserved_name_desc"),
