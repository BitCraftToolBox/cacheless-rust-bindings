...
///
/// Obtain a handle from the [`PavedTileStateTableAccess::paved_tile_state`] method on [`super::RemoteTables`],
/// like `ctx.db.paved_tile_state()`.
///
/// Users are encouraged not to explicitly reference this type,
/// but to directly chain method calls,
/// like `ctx.db.paved_tile_state().on_insert(...)`.
...
/// Extension trait for access to the table `paved_tile_state`.
///
/// Implemented for [`super::RemoteTables`].
pub trait PavedTileStateTableAccess {
    #[allow(non_snake_case)]
    /// Obtain a [`PavedTileStateTableHandle`], which mediates access to the table `paved_tile_state`.
    fn paved_tile_state(&self) -> PavedTileStateTableHandle<'_>;
}

impl PavedTileStateTableAccess for super::RemoteTables {
    fn paved_tile_state(&self) -> PavedTileStateTableHandle<'_> {
        PavedTileStateTableHandle {
            imp: self.imp.get_table::<PavedTileState>("paved_tile_state"),
