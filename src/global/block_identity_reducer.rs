...
pub struct BlockIdentityCallbackId(__sdk::CallbackId);
...
impl block_identity for super::RemoteReducers {
    ...
    fn remove_on_block_identity(&self, callback: BlockIdentityCallbackId) {
        self.imp.remove_on_reducer("block_identity", callback.0)
    }
}

#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `block_identity`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_block_identity {
    /// Set the call-reducer flags for the reducer `block_identity` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
    fn block_identity(&self, flags: __ws::CallReducerFlags);
}

impl set_flags_for_block_identity for super::SetReducerFlags {
    fn block_identity(&self, flags: __ws::CallReducerFlags) {
