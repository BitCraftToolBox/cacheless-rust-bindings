...
impl __sdk::__query_builder::HasCols for TradeOrderState {
    ...
    fn cols(table_name: &'static str) -> Self::Cols {
        TradeOrderStateCols {
            ...
            traveler_trade_order_id: __sdk::__query_builder::Col::new(table_name, "traveler_trade_order_id"),
...
impl __sdk::__query_builder::CanBeLookupTable for TradeOrderState {}
