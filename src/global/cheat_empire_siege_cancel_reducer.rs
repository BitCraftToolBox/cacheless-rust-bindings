...
pub trait cheat_empire_siege_cancel {
    ...
    fn cheat_empire_siege_cancel(&self, siege_node_entity_id: u64,
) -> __sdk::Result<()> {
...
impl cheat_empire_siege_cancel for super::RemoteReducers {
    fn cheat_empire_siege_cancel_then(
        ...
        self.imp.invoke_reducer_with_callback(CheatEmpireSiegeCancelArgs { siege_node_entity_id,  }, callback)
    }
}
