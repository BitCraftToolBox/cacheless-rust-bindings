...
///
/// Obtain a handle from the [`PlayerDeveloperNotificationStateTableAccess::player_developer_notification_state`] method on [`super::RemoteTables`],
/// like `ctx.db.player_developer_notification_state()`.
///
/// Users are encouraged not to explicitly reference this type,
/// but to directly chain method calls,
/// like `ctx.db.player_developer_notification_state().on_insert(...)`.
pub struct PlayerDeveloperNotificationStateTableHandle<'ctx> {
    imp: __sdk::TableHandle<PlayerDeveloperNotificationState>,
