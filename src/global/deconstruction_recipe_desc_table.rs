...
impl DeconstructionRecipeDescTableAccess for super::RemoteTables {
    fn deconstruction_recipe_desc(&self) -> DeconstructionRecipeDescTableHandle<'_> {
        DeconstructionRecipeDescTableHandle {
            imp: self.imp.get_table::<DeconstructionRecipeDesc>("deconstruction_recipe_desc"),
...
impl<'ctx> __sdk::TableLike for DeconstructionRecipeDescTableHandle<'ctx> {
    ...
    fn iter(&self) -> impl Iterator<Item = DeconstructionRecipeDesc> + '_ { self.imp.iter() }
}
...
pub(super) fn register_table(client_cache: &mut __sdk::ClientCache<super::RemoteModule>) {
    ...
    let _table = client_cache.get_or_make_table::<DeconstructionRecipeDesc>("deconstruction_recipe_desc");
...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        __sdk::InternalError::failed_parse(
            "TableUpdate<DeconstructionRecipeDesc>",
            "TableUpdate",
        ).with_cause(e).into()
    })
}
        ...
        pub trait deconstruction_recipe_descQueryTableAccess {
            #[allow(non_snake_case)]
            /// Get a query builder for the table `DeconstructionRecipeDesc`.
            fn deconstruction_recipe_desc(&self) -> __sdk::__query_builder::Table<DeconstructionRecipeDesc>;
        }

        impl deconstruction_recipe_descQueryTableAccess for __sdk::QueryTableAccessor {
            fn deconstruction_recipe_desc(&self) -> __sdk::__query_builder::Table<DeconstructionRecipeDesc> {
                __sdk::__query_builder::Table::new("deconstruction_recipe_desc")
            }
        }
