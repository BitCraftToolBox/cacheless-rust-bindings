...
impl EmpireNodeSiegeStateTableAccess for super::RemoteTables {
    fn empire_node_siege_state(&self) -> EmpireNodeSiegeStateTableHandle<'_> {
        EmpireNodeSiegeStateTableHandle {
            imp: self.imp.get_table::<EmpireNodeSiegeState>("empire_node_siege_state"),
...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        __sdk::InternalError::failed_parse(
            "TableUpdate<EmpireNodeSiegeState>",
            "TableUpdate",
        ).with_cause(e).into()
    })
}
        ...
        #[allow(non_camel_case_types)]
        /// Extension trait for query builder access to the table `EmpireNodeSiegeState`.
        ///
        /// Implemented for [`__sdk::QueryTableAccessor`].
        pub trait empire_node_siege_stateQueryTableAccess {
            #[allow(non_snake_case)]
            /// Get a query builder for the table `EmpireNodeSiegeState`.
            fn empire_node_siege_state(&self) -> __sdk::__query_builder::Table<EmpireNodeSiegeState>;
        }

        impl empire_node_siege_stateQueryTableAccess for __sdk::QueryTableAccessor {
            fn empire_node_siege_state(&self) -> __sdk::__query_builder::Table<EmpireNodeSiegeState> {
                __sdk::__query_builder::Table::new("empire_node_siege_state")
            }
        }
